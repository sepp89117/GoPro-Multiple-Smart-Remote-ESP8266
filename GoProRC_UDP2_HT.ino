...
uint8_t cf[] = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x63, 0x66, 0x2, 0x2, 0x3, 0x0, 0x63, 0x3, 0x28, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0}; //cf 39bytes
...
//uint8_t PA[]= {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x41, 0x02, 0x03}; //HighLight Tag
...
//uint8_t SA[]= {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x41, 0x03, 0x00}; // Shutter for GoPro 5 sent twice: args 3, 0 and second cmd with args 4, 2
...
void receiveFromSerial() {
  ...
  if (ReadSerialMonitorString(sString) > 0) {
    ...
    } else if (strstr_P(sString, PSTR("cf")) != NULL) {
      sendToCam(cf, 39); //get cf
      delay(50);
